  ...
  try {
    ...
    html: `
      ...
      <body>
        <div class="container">
          <header>
            <img src="https://suresh-kirana-store.onrender.com/assets/images/logo/Suresh-logo.png" alt="Store Logo">
          </header>
          <p>${htmlContent}</p>
          ...
          <footer>
            <a href="#"><img src='https://suresh-kirana-store.onrender.com/assets/images/social/facebook.png' width="40px"></a>
